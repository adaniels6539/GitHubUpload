...
public class Prog09 extends Applet
{
	...
	g.fillRect(250, 300, 35, 35);
	g.fillRect(350, 300, 35, 35);
	g.fillRect(450, 300, 35, 35);
	g.fillRect(550, 300, 35, 35);
	g.fillRect(650, 300, 35, 35);
		// draw PAC-MAN
	g.setColor(Color.YELLOW);
	g.fillOval(25, 200, 200, 200);
	g.setColor(Color.BLACK);// mouth
	g.fillArc(35, 200, 200, 200, 300, 100);
	}
